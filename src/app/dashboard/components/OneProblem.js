...
function OneProblem({problem_details}) {
    ...
    return (
        <tr className="sm:hover:bg-[#262D36]  border">
            ...
            <td className="py-1">
                <div className="w-full h-full flex justify-center items-center text-[#F3F4F6] -my-2 py-2 cursor-pointer">
            ...
            <td className="py-1">
                <div className="w-full h-full flex justify-center items-center cursor-pointer -my-2 py-2">
                    <div className="h-6 w-6 relative sm:hover:scale-110 transition-transform delay-100">
            ...
            <td className="py-1">
                <div className="flex justify-center items-center cursor-pointer -my-2 py-2">
                    {problem_details.is_saved && 
                        <BookmarkSolid className="h-5 w-5 text-[#3A82F6] sm:hover:scale-110 transition-transform delay-100"/>
                    }
                    {!problem_details.is_saved && 
                        <BookmarkOutline className="h-5 w-5 sm:h-5 sm:w-5 text-[#8F98A3] sm:hover:scale-110 transition-transform delay-100 sm:hover:text-[#B7C1CD]"/>
                    }
                </div>
            </td>
        </tr>
