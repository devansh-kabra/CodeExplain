...
function DescriptionTab({problem_details}) {
    ...
    return (
        <div className="w-[95%] sm:w-[40%] lg:w-[30%] bg-[#1D232B] border border-[#2A3038] px-4 pt-2 pb-4 rounded flex flex-col gap-3 h-[calc(100dvh-68px)] overflow-y-auto scrollbar-hide" >
